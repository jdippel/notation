...
public class MoveMatch_FindByTarget_Ambiguous {
    ...
    public void testWithArgMethodSource_ReturnLocation( String position, String moveDescription, String target ) {
        ...
        assertThatThrownBy( () ->  notation.findByTarget( moveDescription ) )
                .as( String.format( "an exception is thrown if there are more than one locations for the move to location %s", target ) )
                .isInstanceOf( Chess383NotationException.class )
                .hasMessageContaining( String.format( "There are more pieces" ) )
    ...
    public static Stream<Arguments> MappingProvider() {
        return Stream.of(
            ...
            Arguments.of( "r1b1kb1r/ppp1pppp/2nq1n2/8/2BP4/2N5/PPP2PPP/R1BQK1NR w KQkq - 3 11", "Ne2", "e2" )
