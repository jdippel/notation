...
/**
 * <p>
 * The class Ply_Equals implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 ...
 *
 */
@DisplayName("the public method boolean equals( ) for class Ply is tested")
public class Ply_Equals {
    
    @Test
    @DisplayName("comparing two plies with equals")
    public void equals_WithSameLocations() {
  
        assertThat( Ply.create( "e2", "e4") )
                   .as( "ply with same locations are equal" )
                   .isEqualTo( Ply.create( "e2", "e4" ) );
    }
    ...
    public void equals_WithDifferentLocations() {
        ...
        assertThat( Ply.create( "e2", "e3") )
                   .as( "ply with different locations are not equal" )
                   .isNotEqualTo( Ply.create( "e2", "e4" ) );
    }
}
